...
两篇文章提供简体、繁体和完整英文正文，以及目录、页内搜索和对应语言的 Markdown 下载。正文署名 Kaixuan；英文版注明英译由 AI 辅助。返回栏目链接支持 `?door=thought`、`?door=reading`、`?door=code`，并保留所选语言。蛋白质设计文章与计算神经科学教程使用各自的入口和导航。
