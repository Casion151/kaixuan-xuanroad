(() => {
  ...
  const originalReaderLanguage = document.body.dataset.readerOriginalLang || reader.lang;
  ...
  function applyLanguage(nextLanguage, updateUrl = false) {
    ...
    reader.lang = originalReaderLanguage === 'en' ? 'en' : (language === 'zh-Hant' ? 'zh-Hant' : 'zh-Hans');
